...
const Header = (props: { name: string | number | boolean | ReactElement<any, string | JSXElementConstructor<any>> | ReactFragment | ReactPortal | null | undefined; }) => (
  <nav className="w-full py-6 bg-gray-700 w-screen">
    <div className="flex items-center justify-between mx-auto xl:max-w-7xl lg:max-w-5xl md:max-w-3xl md:px-2 px-4">
      ...
      <section>
        <ul className="md:space-x-8 space-x-6 text-white font-semibold hidden md:flex"></ul>
      </section>
    </div>
  </nav>
);
